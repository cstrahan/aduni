 ...
 * @version $Id: GameFrame.java,v 1.2 2001/01/17 15:34:12 jeff Exp $
 *
*/
...
class GameFrame extends JFrame
{
  public GameFrame() {
    ...
    // Create the default image set randomly (for now)
    imagePackage = new GemImagePackage();
    ...
    for(int i = 0; i < cell.length; i ++)
      for(int j = 0; j < cell[0].length; j++) {
        ...
        cell[i][j].setBounds(i * 40, (j * 40) + 25, 40, 40);
      }
