...
validate_sql = 'SELECT t.team_id,t.team_name,s.school_name,t.date_created,t.member_one_first_name,t.member_one_last_name,t.member_two_first_name,t.member_two_last_name FROM teams t, schools s WHERE t.school_id = s.school_id and t.status = \'not reviewed\';'

invalidate_sql = 'SELECT t.team_id,t.team_name,s.school_name,t.date_created,t.member_one_first_name,t.member_one_last_name,t.member_two_first_name,t.member_two_last_name FROM teams t, schools s WHERE t.school_id = s.school_id'
