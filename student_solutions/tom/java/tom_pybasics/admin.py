...
html_request_password = '''Password Requests: %s users have requested 
passwords from schools<br>'''

html_content_review = '''Content Review: %s people have verified accuracy
of reports posted.<br>%s people have disputed the accuracy of reports
 posted.'''
...
print '<hr>'
print cutoff_date
print html_post_start

print html_post_end
print html_request_password
print html_content_review
