...
##################content_submission3.py, by Tom Hickerson 04/29/01
### the third page, which will display the content being posted to
...
### check_user_sql, takes the id and creates first, last names, email, school
