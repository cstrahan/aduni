...
# gail-2.tcl - processes the Gail Risk Assessment form
# into name db if all is good
# target for: gail.tcl, this script; incoming arguments: ....
...
if { [string equal $error_message ""] } {
    db_dml insert_info "insert into gail
    (gail_id, id, race, age_at_menarche, age_at_first_live_birth, relatives_with_cancer, biopsy_count, biopsy_hyperplasia, creation_date, edit_date)
    values
    (:gail_id, :id, :race, :age_at_menarche, :age_at_first_live_birth, :relatives_with_cancer, :biopsy_count, :biopsy_hyperplasia, sysdate, sysdate)"
    ...
    The following information has been saved for the Gail Assessment for <b>$first_names $last_name</b>.
    <p>
