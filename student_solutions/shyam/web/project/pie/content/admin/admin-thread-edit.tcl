...
# target for: admin-content-edit.tcl; incoming argument: forum, table, edit_id, parent_id, type
...
set page_content "
[html_page_header 2 "Edit thread" "<a href=\"../../admin/admin.tcl\">Administration</a> > <a href=\"admin-content.tcl?forum=$forum\">Administer $forum Q and A</a> Edit thread"]
"
...
if { [string equal $title ""] } {
    set sql_query_parent "select title from $table
...
<form method=post action=admin-content-update.tcl>
