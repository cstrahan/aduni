...
set page_content "
[html_head "Edit thread"]
[html_body_start]
[html_body_top "Edit thread" "<a href=\"../home.tcl\">Home</a> > <a href=\"admin-content.tcl\">Administer content</a> > Edit thread"]
"
...
if { [string equal $title ""] } { ;# Note that :table is not allowed
    set sql_query_parent "select title from $table_type
