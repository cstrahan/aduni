# Edited by Shyam Visweswaran at ADUni
...
# we expect author_name, category, new_category, quote
...
# Now we'll do the insertion in the quotations table.
# Todd implemented Ex6a by sequence instead of lock table, 
# so it is no longer true that:
# " We use a db_dml
...
# changed."
    ...
    # Removed lock table code
    # and set the quotation index as quote_sequence.nextval
    ...
    db_dml insert_quote "insert into quotations
     ...
     "
# note use of quote_sequence.nextval above
...
# todd sjoblom added non-abstract extension to abstract URL
