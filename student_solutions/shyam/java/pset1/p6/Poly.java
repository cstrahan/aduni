/**
 PS-1 Problem 6  - A Polynomial Class modified for RfunLib
...
public class Poly implements Function
{
  ...
  */
  ...
  /**
     Polynomial integration by symbolic integration using 4 parameters.
  */
  public static double defIntegral(double a, double b, int N, Poly p)
  {
    ...
    {
      asum += (p.coef[i] * avar) / (i + 1);
      bsum += (p.coef[i] * bvar) / (i + 1);
      avar = avar * a;
      bvar = bvar * b;
    }
    return (bsum - asum);
  ...
  /**
     Does polynomial integraton by symbolic integration using 3 parameters
  */
  public double defIntegral(double a, double b, int N)
  {
    return defIntegral(a, b, N, this);   
  }
}
